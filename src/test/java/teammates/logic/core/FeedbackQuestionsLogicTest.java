...
public class FeedbackQuestionsLogicTest extends BaseLogicTest {
        ...
        public void testDeleteFeedbackQuestions_byCourseIdAndSessionName_shouldDeleteQuestions() {
                ...
                assertFalse(
                                fqLogic.getFeedbackQuestionsForSession(anotherFsa.getFeedbackSessionName(),
                                                anotherFsa.getCourseId())
                                                .isEmpty());
        ...
        private void testAddQuestion() throws Exception {
                ...
                List<FeedbackQuestionAttributes> actualList = fqLogic
                                .getFeedbackQuestionsForSession(q1.getFeedbackSessionName(), q1.getCourseId());
                ...
                // Add a question to session1course1 and place it between existing question 2
                // and 3
                newQuestion = getQuestionFromDatabase("qn4InSession1InCourse1");
        ...
        public void testUpdateQuestionCascade() throws Exception {
                ...
                FeedbackQuestionAttributes actualQuestion = fqLogic.getFeedbackQuestion(questionToUpdate.getId());
                ...
                int numberOfResponses = frLogic.getFeedbackResponsesForQuestion(
                ...
                fqLogic.updateFeedbackQuestionCascade(
                                FeedbackQuestionAttributes.updateOptionsBuilder(questionToUpdate.getId())
                                                ...
                                                .withNumberOfEntitiesToGiveFeedbackTo(
                                                                questionToUpdate.getNumberOfEntitiesToGiveFeedbackTo())
                                                .build());
                ...
                EntityDoesNotExistException ednee = assertThrows(EntityDoesNotExistException.class,
                                () -> fqLogic.updateFeedbackQuestionCascade(
                                                FeedbackQuestionAttributes.updateOptionsBuilder(finalFq[0].getId())
                                                                .withQuestionDetails(
                                                                                new FeedbackTextQuestionDetails("test"))
                                                                .build()));
        ...
        public void testDeleteFeedbackQuestionCascade_existentQuestion_shouldDoCascadeDeletion() {
                ...
                assertFalse(
                                frcLogic.getFeedbackResponseCommentForSessionInSection(
                                                typicalQuestion.getCourseId(), typicalQuestion.getFeedbackSessionName(),
                                                null).stream()
                                                .noneMatch(comment -> comment.getFeedbackQuestionId()
                                                                .equals(typicalQuestion.getId())));
                ...
                List<FeedbackQuestionAttributes> questionsOfSessions = fqLogic.getFeedbackQuestionsForSession(
        ...
        public void testDeleteFeedbackQuestionCascade_cascadeDeleteResponseOfStudent_shouldUpdateRespondents() {
                ...
                FeedbackQuestionAttributes fqa = fqLogic.getFeedbackQuestion(
                                fra.getFeedbackSessionName(), fra.getCourseId(),
                                Integer.parseInt(fra.getFeedbackQuestionId()));
                ...
                assertEquals(1, frLogic
                                .getFeedbackResponsesFromGiverForCourse(responseInDb.getCourseId(),
                                                responseInDb.getGiver())
                                .stream()
                                .filter(response -> response.getFeedbackSessionName()
                                                .equals(responseInDb.getFeedbackSessionName()))
                                .count());
                ...
                assertFalse(frLogic
                                .getGiverSetThatAnswerFeedbackSession(fqa.getCourseId(), fqa.getFeedbackSessionName())
                                .contains(responseInDb.getGiver()));
        }
        ...
        public void testDeleteFeedbackQuestions_byCourseId_shouldDeleteQuestions() {
                ...
                List<FeedbackQuestionAttributes> questions = fqLogic
                                .getFeedbackQuestionsForSession("Instructor feedback session", courseId);
        ...
        public void testPopulateFieldsToGenerateInQuestion_mcqQuestionDifferentGenerateOptions_shouldPopulateCorrectly() {
                ...
                fqLogic.populateFieldsToGenerateInQuestion(fqa, typicalStudent.getEmail(), null);
                assertEquals(expected, ((FeedbackMcqQuestionDetails) fqa.getQuestionDetailsCopy()).getMcqChoices());
                ...
                feedbackMcqQuestionDetails
                                .setGenerateOptionsFor(FeedbackParticipantType.OWN_TEAM_MEMBERS_INCLUDING_SELF);
                fqa.setQuestionDetails(feedbackMcqQuestionDetails);
        ...
        public void testBuildCompleteGiverRecipientMap_studentQuestion_shouldBuildMapCorrectly() {
                ...
                Map<String, Set<String>> completeGiverRecipientMap = fqLogic
                                .buildCompleteGiverRecipientMap(qn1InSession1InCourse1, courseRoster);
                ...
                assertTrue(completeGiverRecipientMap.get("student1InCourse1@gmail.tmt")
                                .contains("student1InCourse1@gmail.tmt"));
                assertEquals(1, completeGiverRecipientMap.get("student2InCourse1@gmail.tmt").size());
                assertTrue(completeGiverRecipientMap.get("student2InCourse1@gmail.tmt")
                                .contains("student2InCourse1@gmail.tmt"));
                assertEquals(1, completeGiverRecipientMap.get("student3InCourse1@gmail.tmt").size());
                assertTrue(completeGiverRecipientMap.get("student3InCourse1@gmail.tmt")
                                .contains("student3InCourse1@gmail.tmt"));
                assertEquals(1, completeGiverRecipientMap.get("student4InCourse1@gmail.tmt").size());
                assertTrue(completeGiverRecipientMap.get("student4InCourse1@gmail.tmt")
                                .contains("student4InCourse1@gmail.tmt"));
                assertEquals(1, completeGiverRecipientMap.get("student5InCourse1@gmail.tmt").size());
                assertTrue(completeGiverRecipientMap.get("student5InCourse1@gmail.tmt")
                                .contains("student5InCourse1@gmail.tmt"));
        }
        ...
        public void testBuildCompleteGiverRecipientMap_instructorQuestion_shouldBuildMapCorrectly() {
                ...
                Map<String, Set<String>> completeGiverRecipientMap = fqLogic
                                .buildCompleteGiverRecipientMap(qn4InSession1InCourse1, courseRoster);
        ...
        public void testBuildCompleteGiverRecipientMap_selfQuestion_shouldBuildMapCorrectly() {
                ...
                Map<String, Set<String>> completeGiverRecipientMap = fqLogic
                                .buildCompleteGiverRecipientMap(qn3InSession1InCourse1, courseRoster);
        ...
        public void testBuildCompleteGiverRecipientMap_teamQuestion_shouldBuildMapCorrectly() {
                ...
                Map<String, Set<String>> completeGiverRecipientMap = fqLogic
                                .buildCompleteGiverRecipientMap(teamFeedbackQuestion, courseRoster);
        ...
        private void testGetFeedbackQuestionsForStudents() {
                ...
                actualQuestions = fqLogic.getFeedbackQuestionsForStudents("First feedback session",
                                "idOfTypicalCourse1");
                ...
                actualQuestions = fqLogic.getFeedbackQuestionsForStudents("Second feedback session",
                                "idOfTypicalCourse1");
        ...
        private FeedbackQuestionAttributes getQuestionFromDatabase(String questionKey) {
                ...
                question = fqLogic.getFeedbackQuestion(
                                question.getFeedbackSessionName(), question.getCourseId(),
